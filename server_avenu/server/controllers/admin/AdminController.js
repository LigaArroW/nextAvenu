...
exports.authmeAdmin = exports.loginAdmin = void 0;
require("dotenv/config");
var connectionPool_1 = require("../../connectionPool");
var rbac_1 = require("../../auth/rbac");
var mysql = require("mysql");
var jwt = require("jsonwebtoken");
var loginAdmin = function (request, response) {
    try {
...
var authmeAdmin = function (request, response) {
    try {
...
exports.authmeAdmin = authmeAdmin;
