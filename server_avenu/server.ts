...
app.get("/api/authme_admin", AdminController.authmeAdmin);
// app.get("/api/authme_admin", checkPermissions([R.Admin]), AdminController.authmeAdmin);
app.post('/api/update_password', UpdatePasswordUsers.updatePasswordUsers);
// app.patch('/api/update_password', checkPermissions([R.Admin]), UpdatePasswordUsers.updatePasswordUsers);
app.get('/api/get_profiles', UpdatePasswordUsers.getProfilesUsers);
...
app.post("/api/addDistrict", CoreController.addDistrict);
// app.post("/api/addDistrict", checkPermissions([R.Admin]), CoreController.addDistrict);
app.post("/api/updateDistrict", CoreController.updateDistrict);
// app.post("/api/updateDistrict", checkPermissions([R.Admin]), CoreController.updateDistrict);
app.post("/api/deleteDistrict", CoreController.deleteDistrict);
...
app.post("/api/addUnderground", CoreController.addUnderground);
// app.post("/api/addUnderground", checkPermissions([R.Admin]), CoreController.addUnderground);
app.post("/api/updateUnderground", CoreController.updateUnderground);
// app.post("/api/updateUnderground", checkPermissions([R.Admin]), CoreController.updateUnderground);
app.post("/api/deleteUnderground", CoreController.deleteUnderground);
...
app.get("/api/model_views", ModelController.getModelViews);
...
app.post("/api/delete_photo", PhotoController.deletePhoto);
...
app.post("/api/update_photo_status", PhotoController.updatePhotoStatus);
// app.post("/api/update_photo_status", checkPermissions([R.Agency, R.Admin]), PhotoController.updatePhotoStatus);

app.post("/api/delete_video", VideoController.deleteVideo);
...
app.post("/api/add_work_times", WorkTimeController.addWorkTimes);
// app.post("/api/add_work_times", checkPermissions([R.Agency, R.Admin]), WorkTimeController.addWorkTimes);

app.post("/api/add_model_services", ModelServiceController.addModelServices);
...
app.post("/api/add_proposal", ProposalController.addProposal);
// app.post("/api/add_proposal", checkPermissions([R.Admin]), ProposalController.addProposal);
app.post("/api/update_proposal_views", ProposalController.updateProposalViews);
// app.post("/api/update_proposal_views", checkPermissions([R.Admin]), ProposalController.updateProposalViews);

app.post("/api/create_captcha", CaptchaController.getCaptcha);
...
app.post("/api/verify_captcha", CaptchaController.verifyCaptcha);
// app.post("/api/verify_captcha", checkPermissions([R.Agency]), CaptchaController.verifyCaptcha);
app.post("/api/get_positions_up", CaptchaController.getVerificationsforAgency);
