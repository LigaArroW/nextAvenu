...
const UpdatePositionInfoModal: React.FC<IUpdatePositionInfoModalProps> = ({ agency_id, handlerButtonClick, model_id, person }) => {
  ...
  const token = useMemo(() => person.token.split('.')[2], []);
