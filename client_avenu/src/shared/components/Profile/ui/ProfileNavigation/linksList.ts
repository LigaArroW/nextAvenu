...
const LinksList = [
  {
    ...
    links: [
      { id: 0, link: "profile.basic_information", is_only_for_agency: false, link_url: "/profile" } as IProfileLink,
      {
        id: 1,
        link: "profile.login_options",
        is_only_for_agency: false,
        link_url: "/profile/auth-parameters",
      } as IProfileLink,
      {
        id: 2,
  ...
  {
    group: "",
    links: [{ id: 3, link: "global.advertisements", is_only_for_agency: true, link_url: "/profile/advertisements" } as IProfileLink] as IProfileLink[],
  } as IProfileLinkGroup,
  {
    ...
    links: [
      {
        ...
        link_url: "/profile/add-to-blacklist",
      } as IProfileLink,
      {
        id: 5,
